    ...
    */
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'mobile' => ['required','regex:/^([+][9][1]|[9][1]|[0]){0,1}([6-9]{1})([0-9]{9})$/','min:10','unique:users'],
            'password' => ['required', 'string', 'min:8','regex:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,50}/','confirmed'],
        ],[
            'name.required' => 'Name is required',
            'name.regex' => 'Only Alphabet allowed',
