!(function($) {
  ...
  "star": {
    ...
    $(window).on('load', function() {
        ...
        $('#portfolio-flters a.filmenu').on('click', function() {
            $("#portfolio-flters a.filmenu").removeClass('active');
    ...
    $(window).on('load', function() {
        ...
        $('#blog-flters a').on('click', function() {
            $("#blog-flters a").removeClass('active');
            $(this).addClass('active');
    ...
    //     if ($('#headercontact').css('display') === 'none') {
    //         $('#modal_aside_left .close').click();
    //     }
    // }
    // headcontact();
