...
!(function($) {
  ...
  $('#faq').find('a').click(function(){
    ...
    if ($(this).hasClass('faqbg2')) {
      $(this).removeClass('faqbg2');
    }
    else{
      $('#faq').find('a').removeClass('faqbg2');
      $(this).addClass('faqbg2');
    }
  })
  ...
  $('document').ready(function(){
    ...
    $('#features').find('.customer').css('display', 'block');
    $('#features').find('button').removeClass('active-button');
    $(this).addClass('active-button');

  })

    $('#owner').click(function(){
    $('#features').find('.customer').css('display', 'none');
    $('#features').find('.owner').css('display', 'block');
    $('#features').find('button').removeClass('active-button');
    $(this).addClass('active-button');
  })
  ...
  $('#other').click(function(){
    $('#features').find('.customer').css('display', 'none');
    $('#features').find('.other').css('display', 'block');
    $('#features').find('button').removeClass('active-button');
    $(this).addClass('active-button');
  })
