...
!(function($) {
  ...
  $('.filter-button').click(function(){
    ...
    $('.filter-button').css('border','1px solid #000');
    $(this).addClass('filter-active');
    $(this).css('border','0px');

  })

  $('#cust-button').click(function(){
    $('.appfeat-items').find('.cust-feat').show();
  })

  $('#driv-button').click(function(){
    $('.appfeat-items').find('.cust-feat').hide();
    $('.appfeat-items').find('.driv-feat').show();
  })
