...
@section('title', 'Manage Care of employees')  
...
@stop
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Manage Care of employees
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i>Home</a></li>
        <li class="active">Manage Care of employees</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <button class="btn btn-default" ><span class="glyphicon glyphicon-dashboard"></span> Dashboard</button>
             ...
             <button class="btn btn-success add_category"><span class="glyphicon glyphicon-plus"></span> Add Care of employees</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> Care of employees information</h4>
        </div>
          ...
          <div class="modal-body with-padding">
            <div class="form-group">
              <div class="row">
                <div class="col-sm-12">
                  <label>Name :</label>
                   <input type="text" name="title" id="title"  class="form-control" autocomplete="true" value="">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <textarea name="description" id="description"  class="form-control" autocomplete="true"></textarea>
                </div>
              </div>
            </div>
...
$("#category_info").validate({
  ...
  submitHandler: function() {
    ...
    $.ajax({
      url: "add_edit_care_of_employees",
      type: "POST",
      data: data,
      processData: false,
      contentType: false,
  ...
  $.ajax({
        ...
        success: function(result)
        {
          ...
          if(result[0].image){
           ...
           $('#user_image').html("<img src=../public/values/" + result[0].image + " width='20%'>");
          }else{
