        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <button class="btn btn-default" ><span class="glyphicon glyphicon-dashboard"></span> Dashboard</button>
             ...
             <button class="btn btn-success add_category"><span class="glyphicon glyphicon-plus"></span> Add Category</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> Category information</h4>
        </div>
          ...
          <div class="modal-body with-padding">
            <div class="form-group">
              <div class="row">
                <div class="col-sm-12">
                  <label>Name :</label>
                   <input type="text" name="name" id="name"  class="form-control" autocomplete="true" value="">
                </div>
              </div>
            </div>
...
$("#category_info").validate({
  ...
  submitHandler: function() {
    $.ajax({
      url: "add_edit_category",
      type: "POST",
      data: $('#category_info').serialize(),
