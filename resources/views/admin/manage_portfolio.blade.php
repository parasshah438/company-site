        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <button class="btn btn-default" ><span class="glyphicon glyphicon-dashboard"></span> Dashboard</button>
             ...
             <button class="btn btn-success add_category"><span class="glyphicon glyphicon-plus"></span> Add Portfolio</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> Portfolio information</h4>
        </div>
          ...
          <div class="modal-body with-padding">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-sm-12">
                  <label>Url :</label>
                   <input type="text" name="url" id="url"  class="form-control" autocomplete="true" value="">
                </div>
              </div>
            </div>
...
$(document).on('click','.edit',function(){
  ...
  $.ajax({
        ...
        success: function(result)
        {
          ...
          $('#category_id option[value='+result[0].category_id+']').prop('selected', true);
          if(result[0].image){
             $('#user_image').css('display','block');
             $('#user_image').html("<img src=../public/portfolios/" + result[0].image + " width='20%'>");
          }else{
