  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Technology</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <button class="btn btn-default" ><span class="glyphicon glyphicon-dashboard"></span> Dashboard</button>
             ...
             <button class="btn btn-success add_category"><span class="glyphicon glyphicon-plus"></span> Add Technology</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> Technology information</h4>
        </div>
  ...
  $.ajax({
        ...
        success: function(result)
        {
          ...
          if(result[0].image){
           ...
           $('#user_image').html("<img src=../public/technologys/" + result[0].image + " width='20%'>");
          }else{
