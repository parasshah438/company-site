        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <button class="btn btn-default" ><span class="glyphicon glyphicon-dashboard"></span> Dashboard</button>
             ...
             <button class="btn btn-success add_category"><span class="glyphicon glyphicon-plus"></span> Add Testimonial</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> Testimonial information</h4>
        </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <label>Designation :</label>
                   <input type="text" name="designation" id="designation"  class="form-control" autocomplete="true" value="">
                </div>
              </div>
            </div>
  ...
  $.ajax({
        ...
        success: function(result)
        {
          ...
          if(result[0].image){
           ...
           $('#user_image').html("<img src=../public/testimonial/" + result[0].image + " width='20%'>");
          }else{
