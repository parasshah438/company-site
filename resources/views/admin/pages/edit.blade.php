              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input id="banner_title" type="text" class="form-control" name="banner_title" placeholder="Page slug" value="{{$data->banner_title}}">
                      @error('name')
                          <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                          </span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                     ...
                     <img src="{{asset('public/uploads/pages')}}/{{$data->image}}" width="500px;">
                  @error('image')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
