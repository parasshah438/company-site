							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div id="sync1" class="owl-carousel owl-theme">
										<div class="item">
											<img src="{{asset('public/assets/front/images/product/big-1.jpg')}}" alt="">
										</div>
										<div class="item">
											<img src="{{asset('public/assets/front/images/product/big-2.jpg')}}" alt="">
										</div>
										<div class="item">
											<img src="{{asset('public/assets/front/images/product/big-3.jpg')}}" alt="">
										</div>
										<div class="item">
											<img src="{{asset('public/assets/front/images/product/big-4.jpg')}}" alt="">
										</div>
									</div>
