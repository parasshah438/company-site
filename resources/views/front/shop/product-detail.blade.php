			...
			<div class="col-md-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">{{ $productsDetails->name }}</li>
					</ol>
				</nav>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4">
							<div id="sync1" class="owl-carousel owl-theme">
								...
								<div class="item">
									<img src="{{ asset('public/product/subimage/'.$image->path) }}" alt="">
								</div>
								@endforeach
							</div>
						...
						<div class="col-lg-8 col-md-8">
							<div class="product-dt-right">
								...
								<form nam="frmcart" method="post" action="">
								@csrf
								<input type="hidden" name="product_id" id="product_id" value="{{ $productsDetails->id }}">
								...
								<div class="product-group-dt">
									...
									<ul class="gty-wish-share">
										@if($productsDetails['productInventory']['qty'] >0)
										<li>
											<div class="qty-product">
												<div class="">
								<input type="number" class="form-control form-control-sm" value="1" id="product_quantity" name="product_quantity"  min="1" step="1" style="width: 70px; margin-right: 10px; border-color: #000">
										...
										<li><span class="like-icon save-icon" title="wishlist" onclick="addToWishList({{ $productsDetails->id }})"></span></li>
									</ul>
									<ul class="ordr-crt-share">
										<li>
											@if($productsDetails['productInventory']['qty'] >0)
											<button class="add-cart-btn hover-btn add-to-cart-btn"><i class="uil uil-shopping-cart-alt"></i>Add to Cart</button>
											@else
											<button class="add-cart-btn hover-btn" disabled><i class="uil uil-shopping-cart-alt"></i>Out of Stock</button>
											@endif
										</li>
										<li><button class="order-btn hover-btn add-to-cart-btn">Buy Now</button></li>
									</ul>
								</div>
							</form>
					...
					<div class="pdpt-body scrollstyle_4">
						<div class="cart-item border_radius">
							<div class="cart-product-img">
								<img src="{{asset('public/assets/front/images/product/img-6.jpg')}}" alt="">
						...
						<div class="cart-item border_radius">
							<div class="cart-product-img">
								<img src="{{asset('public/assets/front/images/product/img-2.jpg')}}" alt="">
