...
============================================ -->
    ...
    <!-- Countdown JS -->
    <script src="{{url('public/assets/js/plugins/countdown.js') }}"></script>
    <!-- Barrating JS -->
    <script src="{{url('public/assets/js/plugins/jquery.barrating.min.js') }}"></script>
    <!-- Counterup JS -->
    <script src="{{url('public/assets/js/plugins/jquery.counterup.js') }}"></script>
    <!-- Nice Select JS -->
    <script src="{{url('public/assets/js/plugins/jquery.nice-select.js') }}"></script>
    <!-- Sticky Sidebar JS -->
    <script src="{{url('public/assets/js/plugins/jquery.sticky-sidebar.js') }}"></script>
    <!-- Jquery-ui JS -->
    <script src="{{url('public/assets/js/plugins/jquery-ui.min.js') }}"></script>
    <script src="{{url('public/assets/js/plugins/jquery.ui.touch-punch.min.js') }}"></script>
    <!-- Lightgallery JS -->
    <script src="{{url('public/assets/js/plugins/lightgallery.min.js') }}"></script>
    <!-- Scroll Top JS -->
    <script src="{{url('public/assets/js/plugins/scroll-top.js') }}"></script>
    <!-- Theia Sticky Sidebar JS -->
    <script src="{{url('public/assets/js/plugins/theia-sticky-sidebar.min.js') }}"></script>
    <!-- Waypoints JS -->
    <script src="{{url('public/assets/js/plugins/waypoints.min.js') }}"></script>
    <!-- Instafeed JS -->
    <script src="{{url('public/assets/js/plugins/instafeed.min.js') }}"></script>
    <!-- ElevateZoom JS -->
    <script src="{{url('public/assets/js/plugins/jquery.elevateZoom-3.0.8.min.js') }}"></script>
    <!-- Timecircles JS -->
    <script src="{{url('public/assets/js/plugins/timecircles.js') }}"></script>

    <script src="{{url('public/assets/js/jquery.validate.js')}}"></script>

    <script src="{{url('public/js/jquery_notification_v.1.js')}}"></script>

    <!-- Vendor & Plugins JS (Please remove the comment from below vendor.min.js') }} & plugins.min.js') }} for better website load performance and remove js files from avobe) -->
    <!--
<script src="asset('public/assets/js/vendor/vendor.min.js') }}"></script>
<script src="asset('public/assets/js/plugins/plugins.min.js') }}"></script>
-->
