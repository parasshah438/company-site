...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/assets/css/vendor/font-awesome.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/vendor/fontawesome-stars.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/vendor/ion-fonts.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins/slick.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins/animate.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins/jquery-ui.min.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins/lightgallery.min.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins/nice-select.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/plugins/timecircles.css')}}">
    <link rel="stylesheet" href="{{ url('public/assets/css/style.css')}}">
    <link rel="stylesheet" href="{{ url('public/css/jquery_notification.css')}}">
                    ...
                    <div class="ht-right_area">
                        <div class="ht-menu">
                            <ul>
                                ...
                                @else
                                    <li><a href="javascript:void(0);">Hello  {{ ucfirst(Auth::user()->first_name) }} {{ ucfirst(Auth::user()->last_name) }}<i class="fa fa-chevron-down"></i></a>
                                    <ul class="ht-dropdown ht-my_account">
                                        <li><a href="{{url('/')}}/customer/account/profile">Profile</a></li>
                                        <li><a href="{{url('/')}}/customer/account/wishlist">Wishlist</a></li>
                                        <li class="active">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header-logo">
                        <a href="index.html">
                            <img src="{{ url('public/assets/images/menu/logo/1.png') }}" alt="Hiraola's Header Logo">
                        </a>
                    </div>
                </div>
                <div class="col-lg-9">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li><a href="javascript:void(0);">Links</a>
                                    ...
                                    <ul class="hm-dropdown">
                                        <li><a href="{{url('/')}}/page/{{$page->url_key}}">{{$page->page_title}}</a></li>
