                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-info-content">
                            ...
                            <p><a href="https://live.themewild.com/cdn-cgi/l/email-protection"
                                    class="__cf_email__"
                                    data-cfemail="620b0c040d22071a030f120e074c010d0f">[email&#160;protected]</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="contact-form">
                        ...
                        <form method="post" action="https://live.themewild.com/motex/assets/php/contact.php"
                            id="contact-form">
                            <div class="row">
                                <div class="col-md-6">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\marutiinfosoft\resources\views/front/contact.blade.php ENDPATH**/ ?>